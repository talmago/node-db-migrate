...
var Client = (function () {
    ...
    function Client(connectionConfig) {
         ...
         * @returns {*}
         */
        _private._getConnection = function (config, callback) {
    ...
    Client.prototype.execute = function (query, params, callback) {
        ...
        var promise = new Promise(function (resolve, reject) {
            _private._getConnection(_private._connectionConfig, function (err, connection) {
                if (err) return reject(err);
    ...
    Client.prototype.transaction = function(multipleStatements, callback) {
        ...
        var promise = new Promise(function (resolve, reject) {
            _private._getConnection(connectionConfig, function (err, connection) {
                if (err) return reject(err);
